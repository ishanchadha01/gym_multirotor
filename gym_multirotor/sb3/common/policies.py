...
from gym_multirotor.sb3.common.distributions import (
...
from gym_multirotor.sb3.common.preprocessing import get_action_dim, is_image_space, maybe_transpose, preprocess_obs
from gym_multirotor.sb3.common.torch_layers import (
...
from gym_multirotor.sb3.common.type_aliases import PyTorchObs, Schedule
from gym_multirotor.sb3.common.utils import get_device, is_vectorized_observation, obs_as_tensor
...
class BasePolicy(BaseModel, ABC):
    ...
    def predict(
        ...
        actions = actions.cpu().detach().numpy().reshape((-1, *self.action_space.shape))  # type: ignore[misc]
